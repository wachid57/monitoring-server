...
// @Security BearerAuth
// @Router /api/v1.0/admin/roles/bindings [get]
...
// @Security BearerAuth
// @Router /api/v1.0/admin/roles/bindings [post]
...
// @Security BearerAuth
// @Router /api/v1.0/admin/roles/bindings/{id} [get]
...
// @Failure 500 {object} map[string]string
// @Security BearerAuth
// @Router /api/v1.0/admin/roles/bindings/{id} [put]
...
// @Failure 500 {object} map[string]string
// @Security BearerAuth
// @Router /api/v1.0/admin/roles/bindings/{id} [delete]
