...
export default function MemoryMetricsList() {
  ...
  return (
    <PageContainer title="Memory Metrics" description="Monitor memory metrics">
      <Breadcrumb title="Memory Metrics" items={BCrumb} />
      <Card>
        <CardContent>
