...
export default function MetricsIndex() {
  ...
  return (
    <PageContainer title="System Metrics" description="Metrics overview">
      <Breadcrumb title="Metrics Overview" items={BCrumb} />
      <Card>
        <CardContent>
          <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
            <Box sx={{ minWidth: 300 }}>
              <TextField fullWidth placeholder="Search metrics..." value={q} onChange={(e)=>setQ(e.target.value)}
