...
export default function AcknowledgedList() {
  ...
  return (
    <PageContainer title="Acknowledgments" description="Manage acknowledgments">
      <Breadcrumb title="Acknowledgments" items={BCrumb} />
      <Card>
        <CardContent>
          <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
            ...
            <Button variant="contained" startIcon={<IconPlus />} sx={{ width: 225 }}>Add Acknowledgment</Button>
          </Stack>
