...
export default function ContactGroups() {
  ...
  return (
    <PageContainer title="Contact Groups" description="Manage contact groups">
      <Breadcrumb title="Contact Groups" items={BCrumb} />
      <Card>
        <CardContent>
          <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3}>
            ...
            <Button variant="contained" startIcon={<IconPlus />} sx={{ width: 225 }}>Add Contact Group</Button>
          </Stack>
